#!/bin/bash
#
# OMNISIGHT Phase 4 ACAP Package Builder
# Claude Flow Integration (Python Coordinators + Phase 2 Flask API)
#

set -e  # Exit on error

echo "================================================"
echo "OMNISIGHT Phase 4 ACAP Package Builder"
...
# Directories
BUILD_DIR="$PROJECT_ROOT/build-phase4"
...
echo ""
echo "Step 5: Creating manifest.json..."
...
echo ""
echo "================================================"
echo "✓ Phase 4 Package Build Complete!"
echo "================================================"
echo ""
...
echo ""
echo "API Endpoints:"
echo "  • /api/claude-flow/status"
echo "  • /api/claude-flow/swarm/coordinate"
echo "  • /api/claude-flow/timeline/predict"
echo "  • /api/claude-flow/federated/train"
echo "  • /api/claude-flow/federated/aggregate"
echo "  • /api/claude-flow/performance/*"
echo ""
echo "Next Steps:"
echo "  1. Copy package from Docker: docker cp omnisight-dev:/opt/app/output/${PACKAGE_NAME}.eap ./"
echo "  2. Deploy to P3285-LVE via web interface"
echo "  3. Access dashboard at http://camera-ip/local/omnisight/"
echo "  4. Test Claude Flow endpoints"
echo ""
